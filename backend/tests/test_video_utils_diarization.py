...
class VideoUtilsDiarizationTests(unittest.TestCase):
    ...
    def test_assemblyai_speech_models_converts_legacy_values(self):
        self.assertEqual(
            video_utils._assemblyai_speech_models("universal"),
            ["universal-3-pro", "universal-2"],
        )
        self.assertEqual(
            video_utils._assemblyai_speech_models("best"),
            ["universal-3-pro", "universal-2"],
        )
        self.assertEqual(
            video_utils._assemblyai_speech_models("slam_1"),
            ["slam-1"],
        )
