...
DEFAULT_PAUSE_THRESHOLD_MS = 800
...
def normalize_clip_cleanup_settings(
    cut_long_pauses: Any = None,
    pause_threshold_ms: Any = DEFAULT_PAUSE_THRESHOLD_MS,
    remove_filler_words: Any = False,
    filtered_words: Any = None,
) -> dict[str, Any]:
    # Dead-air removal is on by default: viral pacing needs little or no
    # silence. Passing an explicit False still disables it.
    return {
        "cut_long_pauses": True if cut_long_pauses is None else bool(cut_long_pauses),
