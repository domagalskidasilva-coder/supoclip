...
async def process_video_task(
    ...
    clip_duration: int | Dict[str, Any] | None = None,
    ...
    if cleanup_settings is None and isinstance(clip_duration, dict):
        cleanup_settings = clip_duration
        clip_duration = None
    ...
    async with AsyncSessionLocal() as db:
        ...
        try:
            ...
            result = await task_service.process_task(
                ...
                clip_duration=clip_duration if isinstance(clip_duration, int) else None,
